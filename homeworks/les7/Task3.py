...
соответствующий количеству клеток (целое число). В классе должны
...
(не целочисленное) деление клеток, соответственно. В методе деления 4
...
class Cell:
    ...
    def __sub__(self, other):
        if self.quantity - other.quantity > 0:
            ...
            print('Number of cells less than or equal 0!')
    ...
    def make_order(self, cells_in_a_row):
        ...
        for el in range(self.quantity):
            if el != 0 and el % cells_in_a_row == 0:
                result += '\n'
            result += '*'
        return result
