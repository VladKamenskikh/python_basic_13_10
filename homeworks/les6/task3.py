...
Worker. В классе Position реализовать методы получения полного
...
class Position(Worker):
    ...
    def get_full_name(self):
        ...
        print(f'Full name of the worker is {full_name}.')

    def get_total_income(self):
        total_income = self._income["wage"] + self._income["bonus"]
        print(f'Total income of the worker is {total_income} dollars.')


person = Position('Vladislav', 'Kamenskikh', 'Data Analyst', 2000, 3000)
